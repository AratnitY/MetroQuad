...
if IsPlayerEnabled(PLAYER_2) then
	...
	BeginCommand=cmd(visible,StatsP2);
		LoadFont("Common Normal")..{
			...
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
	}
end
...
if IsPlayerEnabled(PLAYER_2) then
	t[#t+1] = Def.ActorFrame{
	BeginCommand=cmd(y,-2;visible,StatsP2);
		-- Left Side
		LoadFont("Common Normal")..{
		...
		LoadFont("Common Normal")..{
			...
			InitCommand=function(self)
				...
				self:visible(false)
				local v = GetCurrentSteps(PLAYER_2):GetRadarValues(PLAYER_2):GetValue(5)
				self:settext(string.format("%05.0f", v))
				self:sleep(0.01)
				self:maxwidth(180)
				self:queuecommand("Update")
				self:AddAttribute( 0, { Length = LeadingToFiveZerosForRadarValue(PLAYER_2,5); Diffuse = ColorDarkTone(White()) } )
			end,
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
		LoadFont("Common Normal")..{
		...
		LoadFont("Common Normal")..{
			...
			InitCommand=function(self)
				ChartJumps=self
				self:visible(false)
				local v = GetCurrentSteps(PLAYER_2):GetRadarValues(PLAYER_2):GetValue(6)
				self:settext(string.format("%05.0f", v))
				self:sleep(0.01)
				self:maxwidth(180)
				self:queuecommand("Update")
				self:AddAttribute( 0, { Length = LeadingToFiveZerosForRadarValue(PLAYER_2,6); Diffuse = ColorDarkTone(White()) } )
			end,
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
		LoadFont("Common Normal")..{
		...
		LoadFont("Common Normal")..{
			...
			InitCommand=function(self)
				ChartHolds=self
				self:visible(false)
				local v = GetCurrentSteps(PLAYER_2):GetRadarValues(PLAYER_2):GetValue(7)
				self:settext(string.format("%05.0f", v))
				self:sleep(0.01)
				self:maxwidth(180)
				self:queuecommand("Update")
				self:AddAttribute( 0, { Length = LeadingToFiveZerosForRadarValue(PLAYER_2,7); Diffuse = ColorDarkTone(White()) } )
			end,
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
		LoadFont("Common Normal")..{
		...
		LoadFont("Common Normal")..{
			...
			InitCommand=function(self)
				ChartMines=self
				self:visible(false)
				local v = GetCurrentSteps(PLAYER_2):GetRadarValues(PLAYER_2):GetValue(8)
				self:settext(string.format("%05.0f", v))
				self:sleep(0.01)
				self:maxwidth(180)
				self:queuecommand("Update")
				self:AddAttribute( 0, { Length = LeadingToFiveZerosForRadarValue(PLAYER_2,8); Diffuse = ColorDarkTone(White()) } )
			end,
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
		-- Right Side
		...
		LoadFont("Common Normal")..{
			...
			InitCommand=function(self)
				ChartHands=self
				self:visible(false)
				local v = GetCurrentSteps(PLAYER_2):GetRadarValues(PLAYER_2):GetValue(9)
				self:settext(string.format("%05.0f", v))
				self:sleep(0.01)
				self:maxwidth(180)
				self:queuecommand("Update")
				self:AddAttribute( 0, { Length = LeadingToFiveZerosForRadarValue(PLAYER_2,9); Diffuse = ColorDarkTone(White()) } )
			end,
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
		LoadFont("Common Normal")..{
		...
		LoadFont("Common Normal")..{
			...
			InitCommand=function(self)
				ChartRolls=self
				self:visible(false)
				local v = GetCurrentSteps(PLAYER_2):GetRadarValues(PLAYER_2):GetValue(10)
				self:settext(string.format("%05.0f", v))
				self:sleep(0.01)
				self:maxwidth(180)
				self:queuecommand("Update")
				self:AddAttribute( 0, { Length = LeadingToFiveZerosForRadarValue(PLAYER_2,10); Diffuse = ColorDarkTone(White()) } )
			end,
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
		LoadFont("Common Normal")..{
		...
		LoadFont("Common Normal")..{
			...
			InitCommand=function(self)
				ChartLifts=self
				self:visible(false)
				local v = GetCurrentSteps(PLAYER_2):GetRadarValues(PLAYER_2):GetValue(11)
				self:settext(string.format("%05.0f", v))
				self:sleep(0.01)
				self:maxwidth(180)
				self:queuecommand("Update")
				self:AddAttribute( 0, { Length = LeadingToFiveZerosForRadarValue(PLAYER_2,11); Diffuse = ColorDarkTone(White()) } )
			end,
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
		LoadFont("Common Normal")..{
		...
		LoadFont("Common Normal")..{
			...
			InitCommand=function(self)
				ChartFakes=self
				self:visible(false)
				local v = GetCurrentSteps(PLAYER_2):GetRadarValues(PLAYER_2):GetValue(12)
				self:settext(string.format("%05.0f", v))
				self:sleep(0.01)
				self:maxwidth(180)
				self:queuecommand("Update")
				self:AddAttribute( 0, { Length = LeadingToFiveZerosForRadarValue(PLAYER_2,12); Diffuse = ColorDarkTone(White()) } )
			end,
			OnCommand=function(self) SCREENMAN:GetTopScreen():AddInputCallback(TabP2Page2) end,
		},
	}
