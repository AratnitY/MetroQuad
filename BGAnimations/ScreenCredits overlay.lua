...
local simplyarrow = {
	"Theme inspired on ''SIMPLY LOVE'' made by hurtpiggypig and Mad Matt",
	"Theme made by Ov3rHell3XoduZ exclusive for Stepmania 5",
}
...
local sections = {
	{ "Theme made by Ov3rHell3XoduZ (Inspired on ''SIMPLY LOVE'' Theme)", simplyarrow },
