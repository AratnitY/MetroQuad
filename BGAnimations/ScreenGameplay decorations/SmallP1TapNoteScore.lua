...
local t = Def.ActorFrame{
	...
	LoadFont("Common Normal")..{
		Name="W1";
		Text="0 / 0.00%";
		InitCommand=cmd(y,SCREEN_TOP+58+20*5;x,SCREEN_CENTER_X-376;zoom,0.5;shadowlength,1;visible,GAMESTATE:IsPlayerEnabled(PLAYER_1);diffuse,color(jColors[1]));
	...
	LoadFont("Common Normal")..{
		Name="W2";
		Text="0 / 0.00%";
		InitCommand=cmd(y,SCREEN_TOP+58+20*7;x,SCREEN_CENTER_X-376;zoom,0.5;shadowlength,1;visible,GAMESTATE:IsPlayerEnabled(PLAYER_1);diffuse,color(jColors[2]));
		OnCommand=function(self) if GAMESTATE:IsPlayerEnabled(PLAYER_1) then self:queuecommand("Update") end end;
		OffCommand=cmd(diffusealpha,1;decelerate,3;diffusealpha,0);
	...
	LoadFont("Common Normal")..{
		Name="W3";
		Text="0 / 0.00%";
		InitCommand=cmd(y,SCREEN_TOP+58+20*9;x,SCREEN_CENTER_X-376;zoom,0.5;shadowlength,1;visible,GAMESTATE:IsPlayerEnabled(PLAYER_1);diffuse,color(jColors[3]));
		OnCommand=function(self) if GAMESTATE:IsPlayerEnabled(PLAYER_1) then self:queuecommand("Update") end end;
		OffCommand=cmd(diffusealpha,1;decelerate,3;diffusealpha,0);
	...
	LoadFont("Common Normal")..{
		Name="W4";
		Text="0 / 0.00%";
		InitCommand=cmd(y,SCREEN_TOP+58+20*11;x,SCREEN_CENTER_X-376;zoom,0.5;shadowlength,1;visible,GAMESTATE:IsPlayerEnabled(PLAYER_1);diffuse,color(jColors[4]));
		OnCommand=function(self) if GAMESTATE:IsPlayerEnabled(PLAYER_1) then self:queuecommand("Update") end end;
		OffCommand=cmd(diffusealpha,1;decelerate,3;diffusealpha,0);
	...
	LoadFont("Common Normal")..{
		Name="W5";
		Text="0 / 0.00%";
		InitCommand=cmd(y,SCREEN_TOP+58+20*13;x,SCREEN_CENTER_X-376;zoom,0.5;shadowlength,1;visible,GAMESTATE:IsPlayerEnabled(PLAYER_1);diffuse,color(jColors[5]));
		OnCommand=function(self) if GAMESTATE:IsPlayerEnabled(PLAYER_1) then self:queuecommand("Update") end end;
		OffCommand=cmd(diffusealpha,1;decelerate,3;diffusealpha,0);
	...
	LoadFont("Common Normal")..{
		Name="MISS";
		Text="0 / 0.00%";
		InitCommand=cmd(y,SCREEN_TOP+58+20*15;x,SCREEN_CENTER_X-376;zoom,0.5;shadowlength,1;visible,GAMESTATE:IsPlayerEnabled(PLAYER_1);diffuse,color(jColors[6]));
		OnCommand=function(self) if GAMESTATE:IsPlayerEnabled(PLAYER_1) then self:queuecommand("Update") end end;
		OffCommand=cmd(diffusealpha,1;decelerate,3;diffusealpha,0);
